/****************************************************************************
** Meta object code from reading C++ file 'lecteurmessage.h'
**
...
#include <memory>
#include "../../lecteurvue/lecteurmessage.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'lecteurmessage.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LecteurMessage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LecteurMessage_t qt_meta_stringdata_LecteurMessage = {
    {
QT_MOC_LITERAL(0, 0, 14) // "LecteurMessage"
...
QT_INIT_METAOBJECT const QMetaObject LecteurMessage::staticMetaObject = { {
    QMetaObject::SuperData::link<QMessageBox::staticMetaObject>(),
    qt_meta_stringdata_LecteurMessage.data,
